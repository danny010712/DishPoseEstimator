...
from config import CROP_THRESHOLD, EPS, MIN_POINTS, COLOR_WEIGHT, COLOR_REF, COLOR_THRESHOLD, SAVE_INTERMEDIATE, BASE_PATH, RESULTS_DIR
from utils.visualization import visualize_step_results

def crop_around(pcd, ref, threshold = CROP_THRESHOLD):
