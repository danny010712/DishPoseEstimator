...
class FastSAMPrompt:
    ...
    def plot_to_result(self,
        ...
        if better_quality:
            ...
            for i, mask in enumerate(annotations):
                ...
                # print(annotations[0].shape) ################################################## ADDED LINE ################################################
        if self.device == 'cpu':
            annotations = np.array(annotations)
            # print(annotations[0].shape) ################################################## ADDED LINE ################################################
            # print(annotations[0][355:365, 615:625]) ################################################## ADDED LINE ################################################
            self.fast_show_mask(
                annotations,
                plt.gca(),
    ...
    def fast_show_mask(
        ...
        # print(np.count_nonzero(indices[0])) ##################################################################################################################
